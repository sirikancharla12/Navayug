  ...
  return (
    <section className="px-6 md:px-10 lg:px-16 py-20 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="hidden md:flex items-start gap-16 lg:gap-24">
          <div className="flex-1 max-w-md">
            <SectionHeader title="Our Story" circleColor="var(--color-soft-gray)" />
            <p className="text-[var(--color-soft-gray)] text-lg font-medium leading-relaxed mt-6">
          ...
          <div className="flex-1">
            <p className="text-gray-900 text-xl lg:text-2xl font-semibold leading-tight tracking-tight mb-8">
